...
<table class="table table-bordered" border="0" width="40%" align="center">
		...
		<h2>Tambah Data Rute Trayek</h2>
	
	<form method="POST">

	<tr>
		<td width="20%">Id Rute</td>
		<td width="80%"><input type="text" name="id_rute" size="50"
			required=""></td>
	</tr>
	<tr>
		<td width="20%">Rute Trayek</td>
		<td width="80%"><input type="text" name="rute" size="50"
			required=""></td>
	</tr>
	<tr>
		<td width="20%"></td>
...
if(isset($_POST['tambah']))
{
	...
	$rute=$_POST['rute'];
	$sql="INSERT into rute values ('$id_rute','$rute')";
